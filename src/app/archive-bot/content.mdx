...
- The bot sends back a confirmation message via Telegram, indicating success or highlighting any issues encountered.
- The temporary files are deleted from the server, keeping everything tidy.
