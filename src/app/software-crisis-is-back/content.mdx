...
The industry eventually clawed its way out through structured programming, object-oriented design, version control, code review, agile. All abstractions that let humans reason about systems too large for any one person to hold in their head.

I think we're entering a second software crisis. The cause is the same: capability has outpaced our ability to manage it.
